"""Scraper for Cafe Europa Bielefeld event listings."""
...
class CafeEuropaScraper(BaseScraper):
    """Scrapes events from Cafe Europa Bielefeld (club venue)."""

    name = "cafe_europa"
    base_url = "https://cafeeuropa.de"
    ...
    def _extract_events(self, soup: BeautifulSoup) -> list[Event]:
        ...
        containers = soup.select(
            ...
            ".elementor-post, .elementor-element, "
            ".grve-event-item, .tribe-events-calendar-list__event"
        )
    ...
    def _parse_card(self, card) -> Event | None:
        ...
        return Event(
            ...
            location="Cafe Europa Bielefeld",
            category="Party",
            image_url=image_url,
        )
